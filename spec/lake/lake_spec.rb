...
describe 'search_w' do
  it 'can search all "W" of lake' do
    expect(search_w(lake, 0, 9)).to eq Set.new([[0, 9], [0, 10], [1, 9], [1, 10], [1, 11], [2, 9], [2, 10], [3, 9], [3, 10], [4, 9], [5, 9], [6, 9], [6, 10], [7, 10], [8, 10], [9, 10]])
  end

  it 'can search all "W" of lake' do
    expect(search_w(lake, 0, 0)).to eq Set.new([[0, 0], [1, 1], [1, 2], [1, 3], [2, 4], [2, 5]])
  end
end
